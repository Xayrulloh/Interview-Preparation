...
23. **What are Union and Intersection Types?**  
    In TypeScript, union types, marked by |, allow a variable to have values
    from different types.  
    Intersection types, shown by &, bring together multiple types to form a new
    type with all properties.
...
29. **List some of the utility types provided by TypeScript and explain their
    usage.**  
